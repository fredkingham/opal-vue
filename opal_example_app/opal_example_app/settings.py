# Django settings for opal_example_app project.
import os
...
SECRET_KEY = 'om+v-uq9l0j!ih8f5xewkm&80idmi#s4wgls%+h6$2kzzb$_0c'
...
ROOT_URLCONF = 'opal_example_app.urls'
APPEND_SLASH = False
...
WSGI_APPLICATION = 'opal_example_app.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = (
    'opal_example_app.migrations',
    'opal_example_app.tests',
    'opal_example_app.local_settings',
    'opal.migrations',
    'opal.tests',
    'opal.wsgi',
)
...
DEFAULT_DOMAIN = 'http://opal_example_app.com/'


# ========== PROJECT ==========
OPAL_BRAND_NAME = 'opal_example_app'
